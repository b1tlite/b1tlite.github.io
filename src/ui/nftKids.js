...
import { enableWeb3, disableWeb3, getNfts, buyNft } from '../web3Api';
...
function prepareNftItemElement(nft, mockItem, index) {
  ...
  head.innerHTML = `${capitalizeFirstLetter(properties.author || 'Unknown author')}, ${properties.age || 'unknown'} years old`;
