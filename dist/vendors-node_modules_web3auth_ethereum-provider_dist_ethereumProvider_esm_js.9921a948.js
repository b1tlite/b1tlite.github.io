(self["webpackChunksen"] = self["webpackChunksen"] || []).push([["vendors-node_modules_web3auth_ethereum-provider_dist_ethereumProvider_esm_js"],{
...
/* harmony import */ var _ethereumjs_common__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ethereumjs/common */ "./node_modules/@ethereumjs/common/dist.browser/index.js");
/* harmony import */ var _ethereumjs_common__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_ethereumjs_common__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _ethereumjs_tx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ethereumjs/tx */ "./node_modules/@ethereumjs/tx/dist.browser/index.js");
/* harmony import */ var _ethereumjs_tx__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_ethereumjs_tx__WEBPACK_IMPORTED_MODULE_8__);
...
/* harmony import */ var ethereumjs_util__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ethereumjs-util */ "./node_modules/ethereumjs-util/dist.browser/index.js");
...
function getProviderHandlers$1(_ref) {
  ...
  return {
    ...
    processTypedMessage: async (msgParams, _) => {
      loglevel__WEBPACK_IMPORTED_MODULE_6___default().debug("processTypedMessage", msgParams);
...
class WalletConnectProvider extends _web3auth_base_provider__WEBPACK_IMPORTED_MODULE_4__.BaseProvider {
  ...
  async onConnectorStateUpdate(connector) {
    connector.on("session_update", async (error, payload) => {
      ...
      const connectedHexChainId = (0,_web3auth_base__WEBPACK_IMPORTED_MODULE_3__.isHexStrict)(connectedChainId) ? connectedChainId : "0x".concat(connectedChainId.toString(16)); // Check if chainId changed and trigger event
...
async function getCommonConfiguration(supportsEIP1559, chainConfig) {
  ...
  const hardfork = supportsEIP1559 ? _ethereumjs_common__WEBPACK_IMPORTED_MODULE_7__.Hardfork.London : _ethereumjs_common__WEBPACK_IMPORTED_MODULE_7__.Hardfork.Berlin;
  ...
  return _ethereumjs_common__WEBPACK_IMPORTED_MODULE_7___default().custom(customChainParams);
}
...
function getProviderHandlers(_ref) {
  ...
  return {
    getAccounts: async _ => ["0x".concat((0,ethereumjs_util__WEBPACK_IMPORTED_MODULE_10__.privateToAddress)(Buffer.from(privKey, "hex")).toString("hex"))],
    ...
    processTransaction: async (txParams, _) => {
      ...
      const unsignedEthTx = _ethereumjs_tx__WEBPACK_IMPORTED_MODULE_8__.TransactionFactory.fromTxData(txParams, {
        common
      });
    ...
    processTypedMessageV3: async (msgParams, _) => {
      loglevel__WEBPACK_IMPORTED_MODULE_6___default().debug("processTypedMessageV3", msgParams);
      const privKeyBuffer = Buffer.from(privKey, "hex");
      const sig = (0,_metamask_eth_sig_util__WEBPACK_IMPORTED_MODULE_9__.signTypedData)({
        privateKey: privKeyBuffer,
        data: msgParams.data,
    ...
    processTypedMessageV4: async (msgParams, _) => {
      loglevel__WEBPACK_IMPORTED_MODULE_6___default().debug("processTypedMessageV4", msgParams);
      const privKeyBuffer = Buffer.from(privKey, "hex");
      const sig = (0,_metamask_eth_sig_util__WEBPACK_IMPORTED_MODULE_9__.signTypedData)({
        privateKey: privKeyBuffer,
        data: msgParams.data,
    ...
    processEncryptionPublicKey: async (address, _) => {
      loglevel__WEBPACK_IMPORTED_MODULE_6___default().info("processEncryptionPublicKey", address);
    ...
    processDecryptMessage: (msgParams, _) => {
      loglevel__WEBPACK_IMPORTED_MODULE_6___default().info("processDecryptMessage", msgParams);
      const stripped = (0,ethereumjs_util__WEBPACK_IMPORTED_MODULE_10__.stripHexPrefix)(msgParams.data);
...
class EthereumPrivateKeyProvider extends _web3auth_base_provider__WEBPACK_IMPORTED_MODULE_4__.BaseProvider {
  ...
  async lookupNetwork() {
    ...
    loglevel__WEBPACK_IMPORTED_MODULE_6___default().debug("this provider", this.provider, chainId, this.state.chainId);
...
//# sourceMappingURL=vendors-node_modules_web3auth_ethereum-provider_dist_ethereumProvider_esm_js.a9784344.map