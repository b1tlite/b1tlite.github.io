"use strict";
(self["webpackChunksen"] = self["webpackChunksen"] || []).push([["vendors-node_modules_web3auth_torus-solana-adapter_dist_torusSolanaAdapter_esm_js"],{
...
class SolanaWalletAdapter extends _web3auth_base__WEBPACK_IMPORTED_MODULE_2__.BaseAdapter {
  ...
  async init(options) {
    ...
    try {
      ...
      loglevel__WEBPACK_IMPORTED_MODULE_4___default().error("Failed to connect with cached torus solana provider", error);
...
//# sourceMappingURL=vendors-node_modules_web3auth_torus-solana-adapter_dist_torusSolanaAdapter_esm_js.90fd96d2.map